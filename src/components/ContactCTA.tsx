    ...
    <section id="contato" className="section">
      <div className="container">
        <div className="cta-block">
          ...
          <h2>Sua nova telefonia está a uma mensagem de distância.</h2>
          <p>
            Não precisa preencher formulário gigante. Manda um
            &lsquo;oi&rsquo; no WhatsApp e a gente toca daí.
          </p>
          <div className="actions">
            ...
            <a href="mailto:marcela@hmsmart.com.br" className="btn btn-ghost" style={{ color: "#fff", borderColor: "rgba(255,255,255,.3)" }}>
              <EmailIcon />
